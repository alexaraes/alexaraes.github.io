    ...
    return (
        <div className="flex flex-col items-center bg-orange-100 pb-10 border-b-2 border-black md:flex-row md:justify-around">
            ...
            <div className="mt-10 md:mt-0">
                ...
                <p className="md:text-4xl">The <span className="text-violet-700">personality hire</span> with skills.</p>
            </div>
            <div className="rounded-full border-4 border-black bg-cyan-400 mt-10 w-4/6 md:w-2/6 ">
