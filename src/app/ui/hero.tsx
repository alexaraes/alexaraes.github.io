...
const Hero = () => {
    return (
        <>
            <div className="pt-5 text-center grow"><p>This site is under construction. Be cool.</p></div>
            <div className="flex flex-col items-center pb-10 border-b-4 border-black md:flex-row md:justify-around">
                ...
                <div className="rounded-full border-4 border-black mt-10 w-4/6 md:w-2/6">
