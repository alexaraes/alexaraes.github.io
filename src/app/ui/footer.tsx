        ...
        <>
            <div className="flex flex-col justify-center items-center border-t-4 border-black bg-redOrange h-36 px-6 sticky top-full text-center md:text-left">
                ...
                <div className="flex flex-row justify-around w-2/6 md:w-1/6 mt-4">
                    <a target="_blank" className="hover:rounded-full p-2 hover:text-white" href="https://www.linkedin.com/in/alexaraes/">
                        <LinkedIn />
                    </a>
                    <a target="_blank" className="hover:rounded-full p-2 hover:text-white" href="https://www.github.com/alexaraes/">
                        <Github />
                    </a>
                </div>
            </div>
